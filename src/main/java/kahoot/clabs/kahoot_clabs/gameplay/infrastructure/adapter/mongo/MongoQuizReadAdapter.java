package kahoot.clabs.kahoot_clabs.gameplay.infrastructure.adapter.mongo;
...
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.persistence.mongo.AnswerOptionDocument;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.persistence.mongo.QuestionAssetDocument;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.persistence.mongo.QuestionDocument;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.persistence.mongo.QuizCategoryDocument;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.persistence.mongo.QuizDocument;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.repository.mongo.SpringAnswerOptionMongoRepository;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.repository.mongo.SpringQuestionAssetMongoRepository;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.repository.mongo.SpringQuestionMongoRepository;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.repository.mongo.SpringQuizCategoryMongoRepository;
import kahoot.clabs.kahoot_clabs.gameplay.infrastructure.repository.mongo.SpringQuizMongoRepository;
