...
public class AuthController {
    ...
    @Operation(
            ...
            description = "Crea un nuevo usuario en la plataforma con email, nombre y contraseña hasheada (BCrypt).")
    ...
    @Operation(
            ...
            description = "Valida credenciales de email y contraseña. Hoy no emite JWT; la protección de rutas está pendiente.")
